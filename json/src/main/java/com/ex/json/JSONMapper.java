...
public class JSONMapper<T> {
    ...
    public JSONObject getJSONObject(Object instacne) throws Exception {
        JSONObject rtObj = null;

        if(instacne==null)
            return rtObj;

        Class<?> clazz = instacne.getClass();
        ...
        for(Field field : fields) {
            ...
            rtObj.put(field.getName(),method.invoke(instacne));
        }
        return rtObj;
    }
    ...
    public ArrayList<T> getValueObjectList(Class<T> clazz, JSONArray jsonArray) throws Exception {
        ...
        ArrayList<T> rtList = new ArrayList<>();
    ...
    public T getValueObject(Class<T> clazz, JSONObject jsonObject) throws Exception {
